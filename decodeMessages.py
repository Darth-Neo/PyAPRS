...
def log_ULTW_Message(field, msg, scale=1.0):
    u"""
...
def log_Fields(fields):
    ...
    # ULTW
        ...
        try:
            ...
            fld[msg] = log_ULTW_Message(fields[1], msg, scale=0.1)

            msg = u"Wind Direction of Wind Speed Peak (0-255)"
            fld[msg] = log_ULTW_Message(fields[2], msg)

            msg = u"Current Outdoor Temp (0_1 deg F increments)"
            fld[msg] = log_ULTW_Message(fields[3], msg, scale=0.1)

            msg = u"Rain Long Term Total (0_01 in increments)"
            fld[msg] = log_ULTW_Message(fields[4], msg, scale=0.01)

            msg = u"Current Barometer (0_1 mbar increments)"
            fld[msg] = log_ULTW_Message(fields[5], msg, scale=0.1)
            ...
            fld[msg] = log_ULTW_Message(fields[9], msg, scale=0.1)

            msg = u"Date (day of year since January 1)"
            fld[msg] = log_ULTW_Message(fields[10], msg)

            msg = u"Time (minute of day)"
            fld[msg] = log_ULTW_Message(fields[11], msg)

            msg = u"Today's Rain Total (0_01 inch increments)"
            fld[msg] = log_ULTW_Message(fields[12], msg, scale=0.01)

            msg = u"Minute Wind Speed Average (0_1kph increments)"
            fld[msg] = log_ULTW_Message(fields[13], msg, scale=0.1)
    ...
    if True:
        try:
            ...
            for lf in logFl:
                ...
                logger.info(u"Message Type Counts : %d" % len(msgs))
