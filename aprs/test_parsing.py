...
def parseMessages(header, footer, n):
    global error_count

    try:
        header_fields, aprs_addresses = parseHF(header, footer, n)

        # Calls parse from APRS
